...
public class ClassUtils {
    ...
    public static Class<?> getClass(
            final java.lang.ClassLoader classLoader, final String className, final boolean initialize) throws ClassNotFoundException {
        try {
            Class<?> clazz;
     ...
     * @throws ClassNotFoundException if the class is not found
     */
    public static Class<?> getClass(final java.lang.ClassLoader classLoader, final String className) throws ClassNotFoundException {
    ...
    public static Class<?> getClass(final String className, final boolean initialize) throws ClassNotFoundException {
        final java.lang.ClassLoader contextCL = Thread.currentThread().getContextClassLoader();
        final java.lang.ClassLoader loader = contextCL == null ? ClassUtils.class.getClassLoader() : contextCL;
